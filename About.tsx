...
export default function About() {
  ...
  const boardOfficers = [
    ...
    { 
      ...
      bio: "Dr. Karla Bailey is founder and CEO of the International Institute of Technology, Education, and Leadership and a Fulbright Specialist with the U.S. Department of State. As a recognized expert and international scholar-practitioner, her work has supported educational institutions across the United States and internationally in strengthening leadership, governance, and responsible innovation.", 
